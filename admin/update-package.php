...
if (strlen($_SESSION['alogin']) == 0) {
	...
	try {
		...
		if (isset($_POST['submit'])) {
			...
			$pclosing_datee = $_POST['closing_date'];
			$pimage = $_FILES["packageimage"]["name"];

			// echo '<pre>                                     ' . var_export($pclosing_date,true) . '</pre>';
								...
								foreach ($results as $result) {	?>
									<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="number" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price is USD" value="<?php echo htmlentities($result->PackagePrice); ?>" required>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="datetime" class="form-control1" name="closing_date" id="packagefeatures" placeholder="Package Features Eg-free Pickup-drop facility" value="<?php echo date("y-m-d H:i:s", $result->closing_date); ?>" required>
											</div>
										</div>
										<div class="form-group">
